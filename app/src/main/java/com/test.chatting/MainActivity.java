...
import com.test.chatting.adapter.ChatFirebaseAdapter;
import com.test.chatting.adapter.ClickListenerChatFirebase;
import com.test.chatting.model.ChatModel;
import com.test.chatting.model.FileModel;
import com.test.chatting.model.MapModel;
import com.test.chatting.model.UserModel;
import com.test.chatting.util.Util;
import com.test.chatting.view.FullScreenImageActivity;
import com.test.chatting.view.LoginActivity;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ClickListenerChatFirebase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Util.verificaConexao(this)){
            Util.initToast(this,"인터넷에 연결해 주세요");
            finish();
        }else{
            bindViews();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://dongwook-160905.appspot.com").child(Util.FOLDER_STORAGE_IMG);
