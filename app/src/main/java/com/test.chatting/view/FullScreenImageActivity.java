package com.test.chatting.view;
...
import com.test.chatting.adapter.CircleTransform;
...
public class FullScreenImageActivity extends AppCompatActivity {
    ...
    private void setValues(){
        ...
        Log.i("TAG","image confirmed "+urlPhotoClick);
        ...
        Glide.with(this).load( urlPhotoClick).asBitmap().override(640,640).fitCenter().into(new SimpleTarget<Bitmap>() {
            ...
            public void onLoadStarted(Drawable placeholder) {
                progressDialog.setMessage("load Image...");
                progressDialog.show();
            }
